"""
This script shows the workflow for generating the expanded network and cycle graph of the Boolean model in Figure 4.
The expanded network and cycle graph are generated and saved in gml files.
...
The user can also choose 'figure_5_Boolean_functions' or 'figure_12_Boolean_functions.txt' from the Figures_data directory
to get the expanded network and cycle graph of the Boolean models in Figure 5 or Figure 12 in the Appendix.
"""
